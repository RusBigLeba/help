...
def _eth_header(data):
    try:
        ...
        globals()['log'].write('\n================== ETH HEADER ==================')
        globals()['log'].write('\n================================================')
        globals()['log'].write('\n{:>20} ,  {}\t'.format('Target MAC',
                                                         '{}:{}:{}:{}:{}:{}'.format(dst_mac[0:2], dst_mac[2:4],
                                                                                    dst_mac[4:6], dst_mac[6:8],
                                                                                    dst_mac[8:10], dst_mac[10:12])))
        globals()['log'].write('\n{:>20} ,  {}\t'.format('Source MAC',
                                                         '{}:{}:{}:{}:{}:{}'.format(src_mac[0:2], src_mac[2:4],
                                                                                    src_mac[4:6], src_mac[6:8],
                                                                                    src_mac[8:10], src_mac[10:12])))
